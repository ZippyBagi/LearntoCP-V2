...
export default function SidebarContainerItem({name, href} : SidebarContainerItemProps){
    ...
    return (
        ...
        <Link href={href} prefetch={true} className={`flex items-center gap-2.5 py-2 text-sm select-none transition-all duration-150 border-l-[3px] py-? pr-3.5 pl-[calc(0.875rem-3px)]
